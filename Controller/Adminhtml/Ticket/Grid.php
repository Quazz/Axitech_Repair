...
This is because based on arguments defined under the axitech_repair_ticket_grid_block.xml file,
...
the entire layout loading, making it load only the bits defined under the axitech_repair_ticket_grid.xml fiel.
*/
